// вставка кода не из библотеки, для доп. стилизации
let shiftCustom;
...
//Слушаем изменение размера окна браузера
...
;(function(root, factory) {
  ...
  ss.prototype = {
    moveBar: function(e) {
      ...
      var totalHeight = this.el.scrollHeight + shiftCustom,
      ...
      var right = isRtl ?
        ...
        (_this.target.clientWidth - _this.bar.clientWidth) * -1 + (shiftCustom / 2);
